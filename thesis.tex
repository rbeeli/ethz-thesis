...
% Bibliography
\addbibresource[label=ownpubs]{bibs/ownpubs.bib}
\addbibresource{bibs/misc.bib}
\addbibresource{bibs/cubic.bib}
\addbibresource{bibs/loose_hypertrees.bib}
\addbibresource{bibs/ms.bib}
\addbibresource{bibs/size-Ramsey_sparse.bib}
